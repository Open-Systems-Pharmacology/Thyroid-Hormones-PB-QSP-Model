Wong_2005_PB <- function(runConfiguration){
  runConfiguration$scenarioName <- "Wong_2005_T4iv_Placebo"
  runConfiguration$simulationTime <- 150*60
  ...
  runConfiguration$scenarioName <- "Wong_2005_T4iv_PB"
  ...
  plotMappingConfiguration <- enum(list(
    ...
    xOffset = list(
      "T4 control simulated" = -7440,
      "T4 PB simulated" = -7440,
      "T4 control data" = -124,
      "T4 PB data" = -124
    ),
  ...
  t4Mapping$addXYSeries(xValsList = observedData$Wong_2005$T4_T4inf_placebo[[X_VALS_COL_NAME]],
                        yValsList = observedData$Wong_2005$T4_T4inf_placebo[[Y_VALS_COL_NAME]],
                        yErrorList = observedData$Wong_2005$T4_T4inf_placebo[[Y_ERROR_COL_NAME]],
                        lables = "T4 control data")
  t4Mapping$addXYSeries(xValsList = observedData$Wong_2005$T4_T4inf_PB[[X_VALS_COL_NAME]],
                        yValsList = observedData$Wong_2005$T4_T4inf_PB[[Y_VALS_COL_NAME]],
                        yErrorList = observedData$Wong_2005$T4_T4inf_PB[[Y_ERROR_COL_NAME]],
                        lables = "T4 PB data")
  t4Mapping$setPlotConfiguration(plotMappingConfiguration)
  t4Mapping$xLim <- c(0, 1)
  t4Mapping$log <- "y"
