Eisenberg_2008_Fig45_600ug <- function(runConfiguration){
  runConfiguration$scenarioName <- "Eisenberg2008Fig45_600ug"
  ...
  eisenberg2008Fig4_T4$addXYSeries(xValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_T4[[X_VALS_COL_NAME]],
                                   yValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_T4[[Y_VALS_COL_NAME]],
                                   lables = "T4 data")
  ...
  eisenberg2008Fig4_T3$addXYSeries(xValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_T3[[X_VALS_COL_NAME]],
                                   yValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_T3[[Y_VALS_COL_NAME]],
                                   lables = "T3 data")
  ...
  eisenberg2008Fig4_TSH$addXYSeries(xValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_TSH[[X_VALS_COL_NAME]],
                                    yValsList = observedData$Eisenberg2008Fig45$IV_600ugT4_Human_TSH[[Y_VALS_COL_NAME]],
  ...
  eisenberg2008Fig4_TSH$yLim <- c(0, 0.15)
  ...
  eisenberg2008Fig8_TSH$yLim <- c(0, 0.1)
  ...
  plotConfiguration$outputName <- "Eisenberg 600µg thyroid concentrations"
#  plotMultiPanel(c(plotMappingT4_thyroid, plotMappingT3_thyroid, plotMappingTSH_thyroid), plotConfiguration)
  plotConfiguration$outputName <- "Eisenberg 600µg pituitary concentrations"
